module github.com/allen13/flake-runner/examples/lambda-file-processor

go 1.24.2

replace github.com/allen13/flake-runner => ../..

require (
	github.com/allen13/flake-runner v0.0.0-00010101000000-000000000000
